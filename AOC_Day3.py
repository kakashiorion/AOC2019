...
intersections = set(firstWire)& set(secondWire)

print(intersections)

def calcDist(item):
    return abs(startX-item[0]) + abs(startY-item[1])
dist=1000000
totalDist=1000000
for item in intersections:
    wire1dist= firstWire[item]
    wire2dist= secondWire[item]
    newTotal=wire1dist+wire2dist
    if(newTotal<totalDist and newTotal!=0):
        totalDist=newTotal
    newDist = calcDist(item)
